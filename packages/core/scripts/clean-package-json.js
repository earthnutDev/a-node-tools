...
packageJson = {
  ...
  keywords: ['a-node-tools', 'node tools', 'node', 'tools'],
  homepage: 'https://earthnut.dev/npm/a-node-tools/',
  dependencies,
  bugs: {
    url: 'https://github.com/MrMudBean/a-node-tools/issues',
    email: 'Mr.MudBean@outlook.com',
  },
  repository: {
    type: 'git',
    url: 'git+https://github.com/MrMudBean/a-node-tools.git',
